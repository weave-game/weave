...
public partial class Player : CharacterBody2D
{
    ...
    private void HandleIndicators()
    {
        ...
        float scaleX = Mathf.Pow(Mathf.Max(0, (MinDistance - distance.X) / MinDistance), 2) * 0.003f;
        float scaleY = Mathf.Pow(Mathf.Max(0, (MinDistance - distance.Y) / MinDistance), 2) * 0.003f;
